...
class RegisterRequest extends BaseRequest
{
    ...
    public function rules():array
    {
        return [
            ...
            "phone" => [
                ...
                'nullable',
                'string',
                'regex:/\(?(\+|00)?([0-9]{0,4})([ .-]?)([0-9]{0,4})([ .-]?)([0-9]{2})\)?([ .-]?)([0-9]{3})([ .-]?)([0-9]{4})/mg'
            ],
            'email' => [
                'bail',
                'required',
    ...
    public function messages():array
    {
        return [
            ...
            'password.regex' => 'Bạn phải nhập mật khẩu có ít nhất 8 ký tự gồm 1 chữ in hoa, 1 chữ in thường, 1 số và 1 ký tự đặc biệt',
